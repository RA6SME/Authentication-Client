...
export default function LoginForm() {
  ...
  return (
    <div>
      ...
      <button
        type="button"
        className="w-full flex items-center justify-center gap-2.5 py-2.5 bg-slate-50 border border-slate-100 rounded-xl text-xs font-medium text-gray-700 hover:bg-slate-100 transition"
      >
